...
import com.example.myapp.widget.SpacesDecoration;

import java.util.List;

public class OrnamentsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    private static final String TAG = "OrnamentsFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAllList = NewsInfo.getDefaultmake(); // 获取默认的服装信息列表
        // 构建一个服装列表的瀑布流适配器
