...
public class MotherFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    private static final String TAG = "MotherFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAllList = NewsInfo.getDefaultmo(); // 获取默认的服装信息列表
        // 构建一个服装列表的瀑布流适配器
