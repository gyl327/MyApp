...
public class MyorderGoodOrder {
    ...
    public String goods_name; // 商品名称
    public double price; // 商品价格
    public int pay_status; // 评价状态。0 未评价；1 已评价
    public String create_time; // 订单创建时间
