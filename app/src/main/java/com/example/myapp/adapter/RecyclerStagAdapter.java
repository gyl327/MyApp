...
import com.example.myapp.widget.RecyclerExtras.OnItemClickListener;
import com.example.myapp.widget.RecyclerExtras.OnItemLongClickListener;
...
//        params.height = new Random().nextInt(1000);
