...
import com.example.myapp.widget.RecyclerExtras;
...
public class MobileGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup vg, int viewType) {
        ...
        return new com.example.myapp.adapter.MobileGridAdapter.ItemHolder(v);
    }

    // 绑定列表项的视图持有者
    public void onBindViewHolder(RecyclerView.ViewHolder vh, final int position) {
        com.example.myapp.adapter.MobileGridAdapter.ItemHolder holder = (com.example.myapp.adapter.MobileGridAdapter.ItemHolder) vh;
