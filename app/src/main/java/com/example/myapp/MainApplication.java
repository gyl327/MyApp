...
import com.example.myapp.database.BookDatabase;
...
public class MainApplication extends Application {
    ...
    private static com.example.myapp.MainApplication mApp; // 声明一个当前应用的静态实例
    ...
    // 利用单例模式获取当前应用的唯一实例
    public static com.example.myapp.MainApplication getInstance() {
        return mApp;
    }
